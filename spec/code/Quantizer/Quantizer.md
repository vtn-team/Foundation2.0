...
- QuantizeAction: クォンタイズされたタイマー。拍数と秒数を引数にとり、指定の拍の時間になったらコールバックを実行する
- QuantizeTimer: クォンタイズされたタイマー。拍数と秒数を引数にとり、指定の拍まで待つ(Unitask.Delayと同じ実装)
- NextMeasureTime: 次の一小節までの時間を返す
